% -----------------------------------------------------------------
% LTC3851A_ex1_compensation_design.m
%
...
%    * Actual cross-over frequency = 49.35 kHz
%    * Cross-over phase-margin     = 56.96 degrees
...
%      - fp = 59.61 kHz
%    * Target cross-over frequency = 50.00 kHz
%    * Actual cross-over frequency = 41.56 kHz
%    * Cross-over phase-margin     = 69.86 degrees
%    * Compensation gain at fsw    = -2.84 dB
%
%   So the cross-over frequency has improved, but with lower
%   phase margin, and the low-frequency zero has been moved
%   much higher, making for a faster controller response.
%
% -----------------------------------------------------------------
...
fz = 30e3;  % adjust until phase margin is 60-degrees
fp = 100e3;  % adjust until gain at fsw = 0

% -----------------------------------------------------------------
% LTspice log file
% -----------------------------------------------------------------
%
% LTC3851A_ex1_bode1.txt contains the measurements at all
% frequency points (including 100 and 300Hz).
%
filename = 'LTC3851A_ex1_bode1.txt';
