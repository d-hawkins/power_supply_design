% -----------------------------------------------------------------
% LTC1735_ex1_bode_response.m
%
% 6/16/2012 D. W. Hawkins (dwh@ovro.caltech.edu)
%
% LTC1735 Bode Response Plots.
%
% This m-file read and plots the Bode response measured using
% the LTSpice LTC1735_ex1_bode.asc circuit. The circuit writes
% the results to its .log file. That log file is then renamed
% to something like LTC1735_ex1_bode1.txt so that LTspice does
...
fco_est   = interp1(gain(1,:),fs,0,'spline');
